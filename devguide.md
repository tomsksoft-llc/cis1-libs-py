...
Соответсвенно при внесении изменений делается новый набор тестов (если он нужен), а старый набор тестов - остается неизменным.
...
_TBD_ каким-то магическим образом при сборке библиотеки должна формироваться документация на нее.
